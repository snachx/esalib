    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        switch (stage) {
            case 1:
                ...
                try {
                    db.executeUpdate("ALTER IGNORE TABLE page DROP INDEX index1");
                } catch (SQLException e) {
                }
                ...
                try {
                    db.executeUpdate("ALTER IGNORE TABLE redirect DROP INDEX index3");
                } catch (SQLException e) {
                }

                try {
                    db.executeUpdate("ALTER IGNORE TABLE redirect DROP INDEX index4");
                } catch (SQLException e) {
                }

                try {
                    db.executeUpdate("ALTER IGNORE TABLE revision DROP INDEX ndx_rev_page");
                } catch (SQLException e) {
                }
